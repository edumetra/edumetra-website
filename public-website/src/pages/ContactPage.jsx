    ...
    const contactMethods = [
        {
            icon: Mail,
            title: 'Email Us',
            value: 'hello@edumetraglobal.com',
            description: 'Send us an email anytime',
            link: 'mailto:hello@edumetraglobal.com',
        },
        {
            icon: Phone,
            title: 'Call Us',
            ...
            link: 'tel:03345336366',
        },
        {
            icon: MapPin,
            title: 'Visit Us',
            value: '5WS8C, West Tower, Mani CasaDona, AA-2F, Newtown, Kolkata - 700160',
            description: 'India',
            link: '#',
        },
    ];
