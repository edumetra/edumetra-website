                        ...
                        <div className="px-8 pt-12 pb-8 text-center space-y-6">
                            <div>
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    You've explored a few colleges today! Create a free account to unlock unlimited browsing, personalized cutoffs, and exclusive student reviews to help you make the best choice.
                                </p>
                            </div>
                            ...
                            <p className="text-xs text-slate-500">
                                Join over 50,000+ students making smart career choices with Edumetra.
                            </p>
                        </div>
                    </motion.div>
                </div>
